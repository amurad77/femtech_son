...
class ProductsCategory(models.Model):
    ...
    image = models.ImageField('Şəkil', upload_to = 'media/productsCategory')
    ...
    def get_uniqe_slug(self):
        ...
        unique_slug = slug
        counter = 1
        while ProductsCategory.objects.filter(slug = unique_slug).exists():
    ...
    def save(self, *args, **kwargs):
        ...
        return super(ProductsCategory, self).save(*args, **kwargs)


class Products(models.Model):

    #information
    products = models.ForeignKey(ProductsCategory, on_delete = models.CASCADE)
    image = models.ImageField('Şəkil', upload_to = 'media/products')
    ...
    title = models.CharField('Başlıq', max_length = 256)
    price = models.IntegerField('Qiymət (AZN)', null=True, blank=True)
    note = tinymce_models.HTMLField('Qeyd', max_length = 10000)
    slug = models.SlugField('Slug', max_length = 110, unique = True, editable = False)
...
class Programs(models.Model):
    ...
    # is_program = models.BooleanField(default=True)
